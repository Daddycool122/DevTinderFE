...
const Requests = () => {
  ...
  if (requests.length === 0) return <div>No requests yet</div>;
          ...
          return (
            ...
            >
              ...
              <div className="flex gap-3 w-full mt-6">
                <button className="btn bg-green-700 flex-1 text-white">Accept</button>
                <button className="btn bg-red-700 flex-1  text-white">Reject</button>
              </div>
            </div>
          );
        })}
